# -*- coding: utf-8 -*-
"""ColBERT_Task2_Tian_BERT_LARGE_UNCASED.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1V2zUpu_WfM7ODyWFOhL-fuRsbbevkiy1
"""
...
plot_model(model, to_file='./Results/ColBERT_Task2_Large_model_plot.png', show_shapes=True, show_layer_names=True)
...
df_sub.to_csv('./Results/ColBERT_LargeUncased_Task2.csv', index=False)